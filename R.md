...
- **having a trim or streamlined appearance suggestive of speed**
	within a few short years their _rakish_ son had squandered the family fortune on hard liquor and fast cars
...
- **profusely widespread**
	a weed that's _rampant_ in this area
	the mayor promised to put a stop to the _rampant_ crime that plagued the city

##### Ramshackle (adjective)
*ˈram-ˌsha-kəl*
- **appearing ready to collapse: rickety**
- **carelessly or loosely constructed**
	The movie's _ramshackle_ plot is confusing and not believable.
...
- **distinctly unpleasant or distasteful: offensive**
	Some foods become _rancid_ quickly.
	an unscrupulous food vendor who's as _rancid_ as the meat that he serves

##### Rancor (noun)
*ˈraŋ-kər*
- **bitter deep-seated ill will**
- **applied to bitter brooding over a wrong**
...
- **friendship, communion**
	He quickly developed a good _rapport_ with the other teachers.
	She works hard to build _rapport_ with her patients.
...
- **plunder, despoil**
	had dark eyes and _raven_ hair
...
- **suggests determined resistance to or defiance of authority**
	acts of sabotage by a _recalcitrant_ populace
	a heart-to-heart talk with the _recalcitrant_ youth revealed that he had a troubled life at home
...
- **to engage in reconnaissance**
	...
	They were sent ahead to _reconnoiter_.

##### Recrimination (noun)
*ri-ˌkri-mə-ˈnā-shən*
- **a retaliatory accusation**
	The discussion turned into a heated debate with _recriminations_ flying back and forth.
	The meeting ended with bitterness and _recrimination_.

##### Recumbent (adjective)
*ri-ˈkəm-bənt*
- **suggestive of repose: leaning, resting**
- **implies the posture of one sleeping or resting**
...
- **evocative, suggestive**
	the kitchen was _redolent_ of garlic and tomatoes
	my grandmother's house always seemed to be _redolent_ with the aroma of baking bread

##### Redoubtable (adjective)
*ri-ˈdau̇-tə-bəl*
- **causing fear or alarm: formidable**
- **illustrious, eminent: worthy of respect**
	There is a new biography of the _redoubtable_ Winston Churchill
	his next opponent, the reigning champion, would be by far the most _redoubtable_ adversary the young boxer had ever faced
...
- **a dining hall (as in a monastery or college)**
	Maybe a knife dropped clumsily on the stone floor of the convent _refectory_, a brief pause in the nuns’ chewing.
	To the left, there’s the marble ruins of the city’s gymnasium, a kind of college campus for trainee soldiers, complete with bathhouse and _refectory_.

##### Refulgence (noun)
*ri-ˈfu̇l-jən(t)s*
- **a radiant or resplendent quality or state: brilliance**
- **often implies properties of an object to reflect light**
	the _refulgence_ of a full moon on a clear autumn night
	the *refulgent* clouds were following the setting sun
...
- **the killing of a king**
	With examples drawn from Scripture and across the length of history, Paine commits rhetorical _regicide_.
	Those Tories by the way have a particular penchant for political _regicide_ before voters get the chance.

##### Regurgitate (verb)
*(ˌ)rē-ˈgər-jə-ˌtāt*
- **to throw or pour back or out from or as if from a cavity**
- **spit out at least partially digested or processed food or information**
...
- **can be a response to a reply or to an objection**
	The article was a stinging _rejoinder_ to her critics.
	he always has a smart-aleck _rejoinder_ to everything

##### Reliquary (noun)
*ˈre-lə-ˌkwer-ē*
- **a container or shrine in which sacred relics are kept**
	Still missing however, is a _reliquary_ brooch set with 94 diamonds.
...
- **the return of a person to custody pending trial or for further detention**
	The judge _remanded_ the case for further consideration.
	Wilson was _remanded_ to the Westmoreland County Prison after failing to post bail.
...
- **objection, exception, compliant**
	Many residents wrote letters of _remonstrance_ to city officials.
	over the vociferous _remonstrances_ of my parents I decided to drop my music lessons

##### Remonstrate (verb)
*ˈre-mən-ˌstrāt*
- **to present and urge reasons in opposition: expostulate -> usually used with _with_**
...
- **suggests unwillingness or inability to submit to discipline or follow orders**
...
- **reluctant**
	the panel decided to investigate the fraud charges against the company, which has always been _reticent_ about its internal operations
	her husband is by nature a _reticent_ person, and she resigned herself to that fact long ago

##### Reticent (adjective)
*ˈre-tə-sənt*
- **restrained in expression, presentation, or appearance**
- **implies a reluctance to speak out or at length, especially about one's own affairs**
	her husband is by nature a _reticent_ person, and she resigned herself to that fact long ago
	he was _reticent_ about his plans

##### Retinue (noun)
*ˈre-tə-ˌnü*
- **a group of retainers or attendants**
	the king and his _retinue_
	a pop star traveling with his _retinue_

##### Revel (verb / noun)
*ˈre-vəl*
- **to take intense pleasure or satisfaction**
- **a usually wild party or celebration**
	*revelling* all night is not conducive to a productive next day at work
	in Finland, Midsummer Day ushers in a nationwide _revel_ as the Finns celebrate the endless hours of sunlight with bonfires and parties
...
- **a rigid grin or grimace usually with the mouth open or lips parted**
	With their teeth bared in a frozen _rictus_ grin, this couple appears to be hiding a darkness which we are left only to guess at.
	Oldman’s features gradually freeze into a _rictus_ of despair, and the lights go out.

##### Rife (adjective)
*ˈrīf*
- **prevalent especially to an increasing degree and often unpleasant**
- **copiously supplied: abounding -> usually used with _with_**
...
- **abundant, exuberant**
	a _riotous_ profusion of flowers
	his _riotous_ mugging always has everyone in hysterics
...
- **divided into pieces or factions**
	...
	In a country _riven_ by deep inequalities, however, opportunity for some came at a loss for others.
...
- **a string of beads used in counting prayers especially of the Roman Catholic rosary**
	And then my mom, who’s super Catholic, pulls out the *rosary*.
	Woken up in the middle of the night to chant the *rosary*.
...
*ˈrau̇nd t͟hə ˈbend*
- **mentally unsound**
	he appears to have gone _around the bend_

##### Rout (noun / verb)
*ˈrau̇t*
- **a crowd of people: rabble**
